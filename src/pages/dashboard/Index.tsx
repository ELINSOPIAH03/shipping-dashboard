            ...
            <main>
                <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                    <div className="flex items-stretch gap-[32px]">
                        <div className="w-[40%] grid grid-cols-2 gap-[16px]">
                            <div className="px-[24px] py-[16px] bg-netral-25 shadow-md flex flex-col gap-[12px]">
                                ...
                                <div className="flex items-center justify-between w-full">
                                    <p className="text-4xl font-bold text-netral-800">433</p>
                            ...
                            <div className="px-[24px] py-[16px] bg-netral-25 shadow-md flex flex-col gap-[12px]">
                                ...
                                <div className="flex items-center justify-between w-full">
                                    <p className="text-4xl font-bold text-netral-800">110</p>
                                    <img src={courseUpIcon} alt="" className='size-[32px]' />
                                </div>
                                <p className="text-sm text-netral-400">
                                    <span className='text-primary-500'>+21% </span>
                            ...
                            <div className="px-[24px] py-[16px] bg-netral-25 shadow-md flex flex-col gap-[12px]">
                                ...
                                <div className="flex items-center justify-between w-full">
                                    <p className="text-4xl font-bold text-netral-800">134</p>
                                    <img src={courseUpIcon} alt="" className='size-[32px]' />
                                </div>
                                <p className="text-sm text-netral-400">
                                    <span className='text-primary-500'>+21% </span>
                            ...
                            <div className="px-[24px] py-[16px] bg-netral-25 shadow-md flex flex-col gap-[12px]">
                                ...
                                <div className="flex items-center justify-between w-full">
                                    <p className="text-4xl font-bold text-netral-800">24</p>
